# source/realman_rl/realman_rl/tasks/manager_based/manipulation/insertion/config/realman/realman_insertion_env_cfg.py

from isaaclab.utils import configclass

from realman_rl.assets.realman import REALMAN_ROBOT_CFG
from realman_rl.tasks.manager_based.manipulation.insertion.insertion_object_env_cfg import RealmanInsertionEnvCfg as InsertionObjectEnvCfgBase


@configclass
class RealmanInsertionEnvCfg(InsertionObjectEnvCfgBase):
    """
    RealMan 机器人的 Insertion 任务配置。
    """
    def __post_init__(self):
        ...
        # -------------------------------------------------------
        self.rewards.insertion_reward.params["asset_cfg"].body_names = [target_ee_body]
